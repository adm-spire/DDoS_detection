...
input_file = r"C:\Users\rauna\Downloads\CSV-01-12 (1)\01-12\DrDoS_SNMP.csv"
output_file = r"C:\Users\rauna\Downloads\balanced_SNMP_Normalized.csv"
...
for chunk in pd.read_csv(input_file, dtype={85: str}, chunksize=chunk_size):
    ...
    # Randomly sample attack data (e.g., 15% of attacks)
    attack_data_sampled = attack_data.sample(frac=0.15, random_state=42)
