...
df = pd.read_csv(r'C:\Users\rauna\Downloads\CSV-01-12 (1)\01-12\DrDoS_SNMP.csv', dtype={85: str})
...
# Save to CSV
df_sampled.to_csv(r'C:\Users\rauna\Downloads\Dr_SNMP_sampled_2.csv', index=False)
